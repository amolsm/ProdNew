...
namespace Dairy {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class DataTable1DataTable : global::System.Data.TypedTableBase<DataTable1Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public DataTable1Row AddDataTable1Row(int ProductID, string ProductName, int Expr1, int Expr2, decimal Expr3, decimal Expr4) {
...
namespace Dairy.DataSet1TableAdapters {
    ...
    public partial class DataTable1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT        od.ProductID, p.ProductName, COUNT(od.ProductID) AS Expr1, SUM(od.Qty) AS Expr2, SUM(od.UnitCost) AS Expr3, SUM(od.Total) AS Expr4
FROM            OrderDetails AS od LEFT OUTER JOIN
