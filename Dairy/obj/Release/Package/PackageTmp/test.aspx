<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="test.aspx.cs" Inherits="Dairy.test" %>
...
<html>
  <head>
    ...
    <link rel="stylesheet" href="/Theme/plugins/colorpicker/bootstrap-colorpicker.min.css">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="/Theme/index.html"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
                <li><a href="/Theme/index2.html"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
            ...
            <li><a href="/Theme/documentation/index.html"><i class="fa fa-book"></i> <span>Documentation</span></a></li>
