<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProductWIseSealsReports.aspx.cs" Inherits="Dairy.Reports.ProductWIseSealsReports" %>
             ...
             <div class="col-lg-3">
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <asp:TextBox ID="tstStartDate" class="form-control"     placeholder="From Date" runat="server" ></asp:TextBox>   
               ...
               <div class="col-lg-3">
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <asp:TextBox ID="txtEndDate"   class="form-control"   placeholder="To Date" runat="server" ></asp:TextBox>   
