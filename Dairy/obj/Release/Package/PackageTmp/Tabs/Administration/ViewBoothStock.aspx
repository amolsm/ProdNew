<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewBoothStock.aspx.cs" Inherits="Dairy.Tabs.Administration.ViewBoothStock" %>
       ...
       <section class="content">
           ...
           <div class="box  ">
            <div class="box-header with-border">
              <h3 class="box-title"><asp:Label ID="lbltital" runat="server" Text="View Booth Stock"></asp:Label> </h3>
