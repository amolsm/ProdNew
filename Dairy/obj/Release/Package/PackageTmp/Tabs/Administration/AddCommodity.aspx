<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddCommodity.aspx.cs" Inherits="Dairy.Tabs.Administration.AddCommodity" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Add Commodity Info</li>
          </ol>
        </section>
      <section class="content">
          ...
          <!-- Default box -->
            ...
            <div class="box-header with-border">
              <h3 class="box-title"><asp:Label runat="server" ID="lblHeaderTab" Text="Add Commodity"></asp:Label></h3>
        ...
        <div class="box-header" style="padding:0px 0px 0px 10px !important">
          <h3 class="box-title">Commodity Information </h3>
        </div><!-- /.box-header -->
        <div class="box-body">
                ...
                <div class="col-lg-3">
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <asp:DropDownList ID="dpType" class="form-control" DataTextField="routeName" DataValueField="routeId" runat="server" selected ToolTip="Select Type Name"> 
                       </asp:DropDownList>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <div class="input-group-addon">
                       ...
                       <asp:TextBox ID="txtCommodity" class="form-control"   placeholder="Commodity Name" ToolTip="Enter Commodity Name" runat="server" required></asp:TextBox>                        
                    </div><!-- /.input group -->
            ...
            <ProgressTemplate>
               ...
               <div class="box ">
            <div class="box-header with-border">
              <h3 class="box-title"> Commodity List </h3>
              <div class="box-tools pull-right">
                      ...
                      <td><%# Eval("CreatedDate")%></td>
                         <td>
                             ...
                             <asp:LinkButton ID="lbEdite" AlternateText="Edit" ForeColor="Gray" OnItemCommand="lbEdite_ItemCommand" 
                                                                    ToolTip="Edit" runat="server" CommandArgument='<%#Eval("CommodityID") %>'
                                                                    CommandName="Edit"><i class="fa fa-edit"></i></asp:LinkButton>

                         </td>
                         <td>   <asp:LinkButton ID="lbdelete" AlternateText="delete" ForeColor="Gray" OnItemCommand="lbdelete_ItemCommand" 
                                                                    ToolTip="Delete" runat="server" CommandArgument='<%#Eval("CommodityID") %>'
