<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GenerateBillForBooth.aspx.cs" Inherits="Dairy.Tabs.Administration.GenerateBillForBooth" %>
  ...
  <%--  <script type="text/javascript">
    ...
    <script type = "text/javascript">
        ...
        <section class="content-header">
          <h1>
             Generate Bill For Booth
            <small>Administration</small>    
          </h1> 
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Administration</a></li>
            <li class="active">Generate Booth bill Info</li>
          </ol>
        </section>
       ...
       <section class="content">
           ...
           <div class="box  ">
            <div class="box-header with-border">
              <h3 class="box-title"><asp:Label ID="lbltital" runat="server" Text="Generate Booth Bill"></asp:Label> </h3>
