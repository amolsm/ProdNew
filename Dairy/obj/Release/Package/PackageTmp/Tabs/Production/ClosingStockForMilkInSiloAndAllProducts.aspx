<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ClosingStockForMilkInSiloAndAllProducts.aspx.cs" Inherits="Dairy.Tabs.Production.ClosingStockForMilkInSiloAndAllProducts" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
      <section class="content-header">
        <h1>
            Closing Stock For Milk In Silo And All Products 
          </h1> 
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Administration</a></li>
            <li class="active">ClosingStockForMilkInSiloAndAllProducts</li>
          </ol>
        </section>
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title"><asp:Label ID="lblHeaderTab" runat="server" Text="Closing Stock For Milk In Silo And All Products"></asp:Label> </h3>
              ...
              <div class="col-lg-3">
                  ...
                  <div class="form-group cntrlbtm">
                    <div class="input-group">
                      <div class="input-group-addon">
                       ...
                       <asp:TextBox ID="txtSiloNo" class="form-control"   placeholder="Enter Silo No For Milk" runat="server" ></asp:TextBox>                        
                    </div><!-- /.input group -->
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Please Enter Silo No For Milk" ControlToValidate="txtSiloNo" ForeColor="Red" ValidationGroup="Save"></asp:RequiredFieldValidator>
                  </div><!-- /.form group -->
               </div>
                  ...
                  <div class="form-group cntrlbtm">
                    <div class="input-group">
                      ...
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Please Enter Milk Type" ControlToValidate="txtMilkType" ForeColor="Red" ValidationGroup="Save"></asp:RequiredFieldValidator>
                  </div><!-- /.form group -->
            </div>
                  ...
                  <div class="form-group cntrlbtm">
                   ...
                   <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Please Enter Quantity" ControlToValidate="txtQuantity" ForeColor="Red" ValidationGroup="Save"></asp:RequiredFieldValidator>
                  </div><!-- /.form group -->
            </div>
...
<%--                        <i class="fa fa-road "></i><span style="color:red">&nbsp;*</span>--%>
                   ...
                   <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Please Enter FAT" ControlToValidate="txtFAT" ForeColor="Red" ValidationGroup="Save"></asp:RequiredFieldValidator>
                  </div><!-- /.form group -->
                 </div>
...
<%--                        <i class="fa fa-road "></i><span style="color:red">&nbsp;*</span>--%>
          ...
          <div class="box ">
            <div class="box-header with-border">
              <h3 class="box-title"> Closing Stock For Milk In Silo And All Products List </h3>
            ...
            <div class="box-body" id="datalist">
                ...
                <table id="example1" class="table table-bordered table-striped">
                      ...
                      <asp:Repeater ID="rpClosingStockForMilkInSiloAndAll" runat="server" OnItemCommand="rpClosingStockForMilkInSiloAndAll_ItemCommand">
               ...
               <ItemTemplate>
                    <tr>
                                        ...
                                        <td><%# Eval("BatchNo")%></td> 
                                        <td><%# Eval("ClosingStockForMilkInSiloAndAllProductsDate")%></td>  
