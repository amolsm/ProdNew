<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BoothroutewiseSalesSummary.aspx.cs" Inherits="Dairy.Tabs.Reports.BoothroutewiseSalesSummary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
      ...
      <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Booth  Sales Summary</li>
          </ol>
        </section>
       ...
       <section class="content">
           ...
           <div class="box  ">
            <div class="box-header with-border">
              <h3 class="box-title"><asp:Label ID="lbltital" runat="server" Text="Booth  Sales Summary"></asp:Label> </h3>
