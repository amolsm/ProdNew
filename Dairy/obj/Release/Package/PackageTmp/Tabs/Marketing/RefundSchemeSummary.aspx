<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RefundSchemeSummary.aspx.cs" Inherits="Dairy.Tabs.Marketing.RefundSchemeSummary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
      ...
      <section class="content-header">
          <h1>
          Refund Scheme Summary
            <small>Administration</small>    
          </h1> 
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Administration</a></li>
            <li class="active"> Refund Scheme Summary</li>
          </ol>
        </section>
       ...
       <section class="content">
           ...
           <div class="box  ">
            <div class="box-header with-border">
              <h3 class="box-title"><asp:Label ID="lbltital" runat="server" Text=" Refund Scheme Summary"></asp:Label> </h3>
                  ...
                  <div class="form-group" >
                    <div class="input-group">
                      <div class="input-group-addon">
                       ...
                       <asp:TextBox ID="txtStartDate" class="form-control"  type="date" placeholder="Date" runat="server" required ToolTip="Start Date" ></asp:TextBox>                        
                    </div><!-- /.input group -->
                  ...
                  <div class="form-group" >
                    <div class="input-group">
                      <div class="input-group-addon">
                       ...
                       <asp:TextBox ID="txtEndDate" class="form-control"  type="date" placeholder="Date" runat="server" required ToolTip="End Date"   ></asp:TextBox>                        
                    </div><!-- /.input group -->
