<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ItemwiseOrderSummary.aspx.cs" Inherits="Dairy.Tabs.Reception.ItemwiseOrderSummary" %>
       ...
       <section class="content">
           ...
           <div class="box  ">
            <div class="box-header with-border">
              <h3 class="box-title"><asp:Label ID="lbltital" runat="server" Text="Itemwise Order Summary"></asp:Label> </h3>
