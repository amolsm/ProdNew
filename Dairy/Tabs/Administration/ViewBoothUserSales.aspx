<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewBoothUserSales.aspx.cs" Inherits="Dairy.Tabs.Administration.ViewBoothUserSales" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type = "text/javascript">
        ...
        <section class="content-header">
          <h1>
             View Booth User Sales
            <small>Administration</small>    
          </h1> 
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Administration</a></li>
            <li class="active">Booth Info</li>
          </ol>
        </section>
