...
{
    public partial class SpotDamageComparisonReport : System.Web.UI.Page
    {
        ...
        protected void btngenrateBill_click(object sender, EventArgs e)
        {
            ...
            DS = billdata.SpotDamageComparisionreportbyDate((Convert.ToDateTime(txtStart1Date.Text)).ToString("dd-MM-yyyy"), (Convert.ToDateTime(txtEnd1Date.Text)).ToString("dd-MM-yyyy"), (Convert.ToDateTime(txtStart2Date.Text)).ToString("dd-MM-yyyy"), (Convert.ToDateTime(txtEnd2Date.Text)).ToString("dd-MM-yyyy"), Convert.ToInt32(dpRoute.SelectedItem.Value), Convert.ToInt32(dpBrand.SelectedValue));
            if (!Comman.Comman.IsDataSetEmpty(DS))
            {
                ...
                try
                {
                    ...
                    sb.Append("<u>Spot-Damage Comparison Reports </u> <br/>");
                    sb.Append("</th>");
