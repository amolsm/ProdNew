<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReturnComparisonReport.aspx.cs" Inherits="Dairy.Tabs.Marketing.ReturnComparisonReport" %>
      ...
      <section class="content-header">
       ...
       Return Comparison Report
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"> Return Comparison Report</li>
          </ol>
        </section>
       ...
       <section class="content">
           ...
           <div class="box  ">
            <div class="box-header with-border">
              <h3 class="box-title"><asp:Label ID="lbltital" runat="server" Text=" Return Comparison Report"></asp:Label> </h3>
