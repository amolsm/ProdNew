<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MarketingSalesAnalysisItemwise.aspx.cs" Inherits="Dairy.Tabs.Marketing.MarketingSalesAnalysisItemwise" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
      ...
      <section class="content-header">
          <h1>
          Agency  Sales Analysis- Itemwise
            <small>Administration</small>    
          </h1> 
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Administration</a></li>
            <li class="active">Agency Sales Analysis- Itemwise</li>
          </ol>
        </section>
       ...
       <section class="content">
           ...
           <div class="box  ">
            <div class="box-header with-border">
              <h3 class="box-title"><asp:Label ID="lbltital" runat="server" Text="Agency Sales Analysis- Itemwise"></asp:Label> </h3>
