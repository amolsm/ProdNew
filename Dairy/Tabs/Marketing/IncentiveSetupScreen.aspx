<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IncentiveSetupScreen.aspx.cs" Inherits="Dairy.Tabs.Marketing.IncentiveSetupScreen" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">  Incentive Rate Setup  </li>
          </ol>
        </section>
    <section class="content">
          ...
          <!-- Default box -->
            ...
            <div class="box-header with-border">
              <h3 class="box-title"><asp:Label runat="server" ID="lblHeaderTab" Text="  Incentive Rate Setup  "></asp:Label></h3>
        ...
        <div class="box-body">
            ...
            <ProgressTemplate>
               ...
               <div class="box ">
            <div class="box-header with-border">
              <h3 class="box-title"> Insentive Rate Setup List </h3>
              <div class="box-tools pull-right">
