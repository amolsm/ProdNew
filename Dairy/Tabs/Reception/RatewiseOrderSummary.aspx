<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RatewiseOrderSummary.aspx.cs" Inherits="Dairy.Tabs.Reception.RatewiseOrderSummary" %>
       ...
       <section class="content">
           ...
           <div class="box  ">
            <div class="box-header with-border">
              <h3 class="box-title"><asp:Label ID="lbltital" runat="server" Text="Ratewise Order Summary"></asp:Label> </h3>
