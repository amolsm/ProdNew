<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RoutewiseSalesSummary.aspx.cs" Inherits="Dairy.Tabs.Despatch.RoutewiseSalesSummary" %>
       ...
       <section class="content">
           ...
           <div class="box  ">
            <div class="box-header with-border">
              <h3 class="box-title"><asp:Label ID="lbltital" runat="server" Text="Routewise Sales Summary"></asp:Label> </h3>
