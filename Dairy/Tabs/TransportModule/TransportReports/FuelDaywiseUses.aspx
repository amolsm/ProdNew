<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FuelDaywiseUses.aspx.cs" Inherits="Dairy.Tabs.TransportModule.TransportReports.FuelDaywiseUses" %>
      ...
      <section class="content-header">
        ...
        Fuel Datewise Uses
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Fuel Datewise Uses</li>
          </ol>
        </section>
       ...
       <section class="content">
           ...
           <div class="box  ">
            <div class="box-header with-border">
              <h3 class="box-title"><asp:Label ID="lbltital" runat="server" Text="Fuel Datewise Uses"></asp:Label> </h3>
