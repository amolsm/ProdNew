<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MilkSupplyVehicleReportRoutewise.aspx.cs" Inherits="Dairy.Tabs.TransportModule.TransportReports.MilkSupplyVehicleReportRoutewise" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
      ...
      <section class="content-header">
          <h1>
       Milk Supply Vehicles Report[Routewise]
            <small>Administration</small>    
          </h1> 
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Administration</a></li>
            <li class="active">Milk Supply Vehicles Report[Routewise]</li>
          </ol>
        </section>
       ...
       <section class="content">
           ...
           <div class="box  ">
            <div class="box-header with-border">
              <h3 class="box-title"><asp:Label ID="lbltital" runat="server" Text="Milk Supply Vehicles Report[Routewise]"></asp:Label> </h3>
                  ...
                  <div class="form-group" >
                    <div class="input-group">
                      <div class="input-group-addon">
                       ...
                       <asp:TextBox ID="txtStartDate" class="form-control"  type="date" placeholder="Date" runat="server" required ToolTip="Enter Start Date" ></asp:TextBox>                        
                    </div><!-- /.input group -->
                  ...
                  <div class="form-group" >
                    <div class="input-group">
                      <div class="input-group-addon">
                       ...
                       <asp:TextBox ID="txtEndDate" class="form-control"  type="date" placeholder="Date" runat="server" required ToolTip="Enter End Date" ></asp:TextBox>                        
                    </div><!-- /.input group -->
