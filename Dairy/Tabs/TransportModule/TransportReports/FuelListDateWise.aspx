<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FuelListDateWise.aspx.cs" Inherits="Dairy.Tabs.TransportModule.TransportReports.FuelListDateWise" %>
      ...
      <section class="content-header">
        ...
        Fuel List-Datewise
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Fuel List-Datewise</li>
          </ol>
        </section>
       ...
       <section class="content">
           ...
           <div class="box  ">
            <div class="box-header with-border">
              <h3 class="box-title"><asp:Label ID="lbltital" runat="server" Text="Fuel List-Datewise"></asp:Label> </h3>
