...
{
    public partial class SalesAnalysisItemwise : System.Web.UI.Page
    {
        ...
        protected void btngenrateBill_click(object sender, EventArgs e)
        {
            ...
            DS = billdata.SalesAnalysisitemwiseByDate((Convert.ToDateTime(txtStartDate.Text)).ToString("dd-MM-yyyy"), (Convert.ToDateTime(txtEndDate.Text)).ToString("dd-MM-yyyy"), Convert.ToInt32(dpRoute.SelectedItem.Value), Convert.ToInt32(dpBrand.SelectedValue));
            if (!Comman.Comman.IsDataSetEmpty(DS))
            {
