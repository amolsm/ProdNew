<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BoothBillWiseSalesSummary.aspx.cs" Inherits="Dairy.Tabs.Reports.BoothBillWiseSalesSummary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%--  <script type = "text/javascript">
          function PrintPanel1() {
              var panel = document.getElementById("<%=pnlBill1.ClientID %>");
              var printWindow = window.open('', '', 'height=400,width=800');
              printWindow.document.write("<html> <head> <style type='text/css'>.style1{border-collapse:collapse;font-size: 12px; font-family: sans-serif;}</style>");
              printWindow.document.write('</head><body >');
              printWindow.document.write(panel.innerHTML);
      ...
      <section class="content-header">
          <h1>
           Booth Billwise Sales Summary
            <small>Administration</small>    
          </h1> 
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Administration</a></li>
            <li class="active">Booth Billwise Sales Summary</li>
          </ol>
        </section>
       ...
       <section class="content">
           ...
           <div class="box  ">
            <div class="box-header with-border">
              <h3 class="box-title"><asp:Label ID="lbltital" runat="server" Text="Booth Billwise Sales Summary"></asp:Label> </h3>
                 ...
                 <div class="col-lg-3">
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <asp:DropDownList ID="dpAgent" class="form-control"  DataTextField="Name" DataValueField="AgentID" runat="server" AutoPostBack="true" OnSelectedIndexChanged="dpAgent_SelectedIndexChanged" > 
                       </asp:DropDownList>
                ...
                <%--<div class="col-lg-3">
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <asp:DropDownList ID="dpSelectreport" class="form-control"  AutoPostBack="true" OnSelectedIndexChanged="dpSelectreport_SelectedIndexChanged" runat="server" > 
                           <asp:ListItem Value="0">--Select Report--</asp:ListItem>
                          <asp:ListItem Value="1">All Report</asp:ListItem>
                          <asp:ListItem Value="2">Agent and Employee</asp:ListItem>
