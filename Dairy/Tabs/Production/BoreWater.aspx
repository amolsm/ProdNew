<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BoreWater.aspx.cs" Inherits="Dairy.Tabs.Production.BoreWater" %>
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">BoreWater</li>
                 ...
                 <div class="box">
                   ...
                   <h3 class="box-title"><asp:Label ID="lblHeaderTab" runat="server" Text="Bore Water Details"></asp:Label> </h3>
                 ...
                 <div class="col-lg-3">
                  <div class="form-group cntrlbtm">
                    <div class="input-group">
                      ...
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please Enter Time" ControlToValidate="txtEndTime" ForeColor="Red" ValidationGroup="Save"></asp:RequiredFieldValidator>
                  </div><!-- /.form group -->
                 </div>
                  ...
                  <div class="form-group cntrlbtm">
                    <div class="input-group">
                      <div class="input-group-addon">
                          <asp:Label ID="Label6" runat="server" Text="Total Hours"></asp:Label>
                      </div>
                       <asp:TextBox ID="txtTotalHours" class="form-control" type="time"        placeholder="End Time" ToolTip="End Time" runat="server" ></asp:TextBox>        
                    </div><!-- /.input group -->
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Please Enter Time" ControlToValidate="txtTotalHours" ForeColor="Red" ValidationGroup="Save"></asp:RequiredFieldValidator>
                  </div><!-- /.form group -->
                 </div>
           ...
           <div id="bx2" class="box collapsed-box">
            <div class="box-header with-border">
              <h3 class="box-title"> Bore Water List </h3>
             ...
             <asp:UpdatePanel runat="server" ID="uprouteList" UpdateMode="Conditional">
              <ContentTemplate>
                ...
                <table id="example1" class="table table-bordered table-striped">
                      ...
                      <asp:Repeater ID="rpborewater" runat="server" OnItemCommand="rpborewater_ItemCommand">
