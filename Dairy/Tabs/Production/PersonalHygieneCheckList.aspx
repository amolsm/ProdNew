<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PersonalHygieneCheckList.aspx.cs" Inherits="Dairy.Tabs.Production.PersonalHygieneCheckList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">PersonalHygieneCheckList</li>
          </ol>
        </section>
     ...
     <section class="content">
             ...
             <div class="box">
                   ...
                   <h3 class="box-title"><asp:Label ID="lblHeaderTab" runat="server" Text="Personal Hygiene CheckList Details"></asp:Label> </h3>
...
<%--                      <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Please Enter Mask" ControlToValidate="txtMask" ForeColor="Red" ValidationGroup="Save"></asp:RequiredFieldValidator>--%>
            ...
            <div class="box-header with-border">
              <h3 class="box-title"> Personal Hygiene CheckList </h3>
             ...
             <asp:UpdatePanel runat="server" ID="uprouteList" UpdateMode="Conditional">
              <ContentTemplate>
                ...
                <table id="example1" class="table table-bordered table-striped">
                      ...
                      <asp:Repeater ID="rpPersonalHygieneCheckList" runat="server" OnItemCommand="rpPersonalHygieneCheckList_ItemCommand">
                    ...
                    <tr>
                         ...
                         <td>
                             <asp:LinkButton ID="lbEdite" AlternateText="Edit" ForeColor="Gray" onItemCommand="lblEdite_ItemCommand" 
                                                                    ToolTip="Edit" runat="server" CommandArgument='<%#Eval("PersonalHygieneCheckListId") %>'
